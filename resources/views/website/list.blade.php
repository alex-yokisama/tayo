<x-custom-layout>
    ...
    <x-slot name="top">
        <div class="flex flex-row items-center justify-between">
            <x-common.h.h1>Websites</x-common.h.h1>
            <x-common.button.group>
                ...
                <x-common.button.a href="/admin/website?backUrl={{ urlencode($backUrl) }}">New</x-common.button.a>
            </x-common.button.group>
        </div>
            ...
            <x-common.table.table x-data="tableComponent()">
                ...
                @foreach ($items as $item)
                    <x-common.table.tr>
                        ...
                        <x-common.table.td>
                            @if ($item->logo != null)
                                <div class="w-16 h-16 bg-contain bg-no-repeat bg-center" style="background-image: url('{{ $item->logoUrl }}');"></div>
                            @endif
                        </x-common.table.td>
                        <x-common.table.td>
